...
weaver \
    --data-train "${DATADIR}/MC__*_M130_*_UL18_[1-9].root" \
    --data-test "${DATADIR}/MC__*_M130_*_UL18_[1-9].root" \
    ...
    --batch-size 512 --samples-per-epoch 160000 --samples-per-epoch-val 20000 --num-epochs 2 \
